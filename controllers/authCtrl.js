    ...
    googleLogin: async (req, res) => {
        try {
            ...
            if(user){
                ...
                const newUser = new Users({
                    fullname:given_name,username:family_name, email:email, password: passwordHash, images: picture
                })
                await newUser.save()
    ...
    facebookLogin: async (req, res) => {
        try {
            ...
            if(user){
                ...
                const newUser = new Users({
                    fullname:name,username:name, email:email, password: passwordHash, images: picture.data.url
                })
                await newUser.save()
